        ...
        try {
            ...
            foreach ($conditions as $condition) {
                ...
                $query = $this->options['model']::when(isset($this->options['filter_field']), function ($query) {
                    ...
                    if (isset($this->options['filter_days'])) {
                        return $query->where(
                            ...
                            '>=',
                            Carbon::now()->subDays($this->options['filter_days'])->format($this->options['date_format_filter_days'] ?? 'Y-m-d')
                        );
                ...
                if (
                    ...
                    CarbonPeriod::since(Carbon::now()->subDays($this->options['filter_days']))
                        ->until(Carbon::now())
